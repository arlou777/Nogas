...
class ProfileController extends Controller
{
    ...
    {   
        ...
        return Redirect::route('profile2.edit2')->with('status', 'profile-updated');
    }
    ...
    {   
        ...
        return Redirect::route('profile3.edit3')->with('status', 'profile-updated');
    }
