...
@endif
<Center>
  <h3 class="text-success"><strong>Finished Events</strong></h3>
  </Center>
  <br>
  <br>
  ...
  <div class="col-12">
    ...
    <br>
      ...
      <section class="intro">
        <center>  <h3 class="text-success"><strong></strong></h3></center>
        <br>
        <br>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        ...
                        <tr >
                            ...
                            <td class="border border-dark"><strong>{{ $item->description }}</td>
