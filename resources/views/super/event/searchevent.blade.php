...
<div class="container">
  <div class="row">
    ...
    <div class="col-12">
      <form type="get" action="/search" enctype="multipart/form-data">
        <div class="row">
          <div class="input-group border">
            <input type="search" name="query" value="" class="form-control" placeholder="Search Event Type ...">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <tr>
                      ...
                      <td class="border border-dark"><strong>{{ $item->toDate }}</stro></td>
