...
@section('content')
<Center>
    <h3 class="text-success"><strong> Edit Participant</strong></h3>
    </Center>
...
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-header">
                ...
                <a href="/indexs" class="fw-bold fs-5 btn btn-success"> <i class="fa fa-arrow-left"> </i>Back</a>
                <br><br>
        ...
        <div class="card-body">
            <div class="row">
            <div class="col-md-12">
                <form action="/partupdates/{{ $participants->id }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <p>Previously Uploaded File: {{ $participants->documents }}</p>
                        ...
                        <a href="/indexs" class="btn btn-danger">Cancel</a>
