...
<div class="container">
  <div class="row">
    <div class="col-12">
      <form type="get" action="/searchs" enctype="multipart/form-data">
        <div class="row">
          <div class="input-group border">
            <input type="search" name="query" value="" class="form-control" placeholder="Search for Event type ....">
          ...
          <div class="col-md-12">
              <div class="card">
                ...
                <div class="col-12">
                  ...
                  <a href="/eventfinishs" class="btn btn-warning btn-sm float-right" title="finished event">
                    <i class="fa fa-eye" aria-hidden="true"></i>Finished Events
                </a>
                                      
                  <a href="/addss" class="btn btn-success btn-sm float-right " title="Add New Event">
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  <tr >
                      ...
                      <td class="border border-dark"><strong>{{ $item->date }}</st></td>
