...
<body>
    ...
    <table>
        <thead class="border border-2" >
            <tr>
                <th  class="font-weight-bold border  text-success fs-6">Full Name</th>
                            <th  class="font-weight-bold border  text-primary fs-6">Course & Year</th>
                            <th  class="font-weight-bold border  text-primary fs-6">Email</th>
                            <th  class="font-weight-bold border  text-primary fs-6">Contect</th>
                          
                            <th  class="font-weight-bold border text-success fs-6">Signature</th>
