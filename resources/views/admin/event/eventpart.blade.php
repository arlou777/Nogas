                            ...
                            <div class="col-12">
                              ...
                              <div class="card">
                                <div class="card-body">
                                  <div class="table-responsive">
                                    <table class="table table-hover mb-0">
                                      ...
                                      <a href="/eventss" class="fw-bold fs-5 btn btn-success">Back</a>
                                      <br>
                                      <br>
                                ...
                                <th scope="col" class="font-weight-bold border text-success fs-6">Full Name</th>
                                      ...
                                      <th scope="col" class="font-weight-bold border text-success fs-6">ID of The Program</th>
                                      <th scope="col" class="font-weight-bold border text-success fs-6"> Navigatu ID</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="border "><strong>{{ $item->events_id }}</strong></td>
                                        <td class="border "><strong>{{ $item->user_id }}</strong></td>
                                        ...
                                        <td>
                                          <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                              <a href="{{ route('export.pdf') }}" class="dropdown-item">Export as PDF</a>
                                              <a class="dropdown-item" href="/shows/{{ $item->id }}">View</a>
                                              <a class="dropdown-item" href="/partedits/{{ $item->id }}">Edit</a>
                                              <form method="POST" action="/partdeletes/{{$item->id}}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
