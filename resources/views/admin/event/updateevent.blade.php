...
<center> <h3 class="text-success"><strong>Edit/Add document Event</strong></h3></center>
<br>
<br>
<div class="row">
<div class="col-md-12">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
            <div class="col-md-12">
                <form action="/eventadds/{{ $events->id }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PUT') }}
                    ...
                    <div class="form-group">
                        ...
                        <a href="/eventss" class="btn btn-danger">Cancel</a>
